...
<body id="page-top" style="background: url(https://scontent.fcmn3-2.fna.fbcdn.net/v/t1.6435-9/123449799_102469721672949_6609204749632495978_n.jpg?_nc_cat=106&ccb=1-5&_nc_sid=e3f864&_nc_ohc=-7O4H_6ih0cAX_Vwibe&_nc_ht=scontent.fcmn3-2.fna&oh=00_AT-4qUPkK15ujS-IDE24H8i0e1FtxK13vRKfN6ZvihCzkw&oe=627A9866);background-position: center;">
    <!-- Navigation-->
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#page-top">ENSAJ</a>
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">ECOLE NATIONALE DES SCIENCES APPLIQUEES</h1>
                    <hr class="divider" />
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">Plateforme de gestion des doctorants ENSAJ</p>
                    <a class="btn btn-primary btn-xl" href="{{ route('login') }}">S'identifier</a>
                </div>
            </div>
        </div>
    </header>
